...
import com.mss.imageloader.adapter.PicassoAdapter;
...
public class PicassoActivity extends BaseActivity
{
    ...
    private void initAdapter ()
    {
        ...
        adapter = new PicassoAdapter(this, mUrlList);
        ...
        gridView.setOnItemClickListener(new AdapterView.OnItemClickListener()
        {
            ...
            public void onItemClick (AdapterView<?> adapterView, View view, int i, long l)
            {
                ...
                Intent intent = new Intent(PicassoActivity.this, PicassoImageShowActivity.class);
